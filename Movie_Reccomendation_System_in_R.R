...
#Retrieving data
movie_data <- read.csv("D:/Movie_Reccomendation_System_in_R/movies.csv", stringsAsFactors = FALSE)
rating_data <- read.csv("D:/Movie_Reccomendation_System_in_R/ratings.csv")
